...
const SortablePlayerCard: React.FC<SortablePlayerCardProps> = ({ player }) => {
  const {
    attributes,
    listeners,
    setNodeRef,
  ...
  return (
    <div
      ...
      style={{
        ...style,
        border: `1.5px solid ${isDragging ? 'var(--color-blue)' : 'var(--color-line)'}`,
    ...
    >
      <div {...listeners} className="flex-shrink-0" style={{ color: 'var(--color-ink-soft)', cursor: 'grab' }}>
